...
### 收藏了 300 条视频，却一条都没复盘过？

**抖音收藏夹批量下载 · 口播转文字 · 结构化整理**

把抖音里「只收藏、不看」的内容，变成可以搜索、统计、分析、导入笔记的本地资料。
...
python download_collects.py --mode favorites   # 只下载「收藏的视频」（不按文件夹分类）
...
cp config.example.yml config.yml   # 若尚无配置文件
